...
<img width="480" height="75" alt="image" src="https://github.com/user-attachments/assets/70be9880-99dd-416c-917d-b3bf9ba9270d" />
...
<img width="392" height="111" alt="image" src="https://github.com/user-attachments/assets/8c18e55f-c57f-4b52-8e37-f8737e7e7d5c" />
...
<img width="494" height="123" alt="image" src="https://github.com/user-attachments/assets/d3ac2e4b-6393-4ee0-97c8-6e2e0c743928" />
...
<img width="498" height="77" alt="image" src="https://github.com/user-attachments/assets/3db84b85-c054-4d65-bf56-107d06126f57" />
...
void convertFirstCLastC(char str[])
{
    ...
    /* Convert first and last characters of each word */
    for(i = 1; i < len - 1; i++)
    {
        if(str[i] == ' ')
        {
            str[i - 1] = toupper(str[i - 1]); /* Last character of previous word */
            str[i + 1] = toupper(str[i + 1]); /* First character of next word */
        }
    }

    /* Convert last character of the string */
...
<img width="556" height="63" alt="image" src="https://github.com/user-attachments/assets/b16510c5-2c31-4cb3-afac-9a13df878b2d" />
